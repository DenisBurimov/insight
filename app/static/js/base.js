...
var docListItems = document.querySelectorAll('.doc-list-item');
function setCardBackground(item, className) {
    docListItems.forEach(function (el) { return el.classList.remove('bg-blue-200'); });
    docListItems.forEach(function (el) { return el.classList.remove('bg-gray-800'); });
    ...
    themeToggleBtn.addEventListener('click', function () {
        ...
        if (localStorage.getItem('color-theme')) {
            if (localStorage.getItem('color-theme') === 'light') {
                ...
                var selectedCard = document.querySelector('.doc-list-item.bg-blue-200');
                ...
                var selectedCard = document.querySelector('.doc-list-item.bg-gray-800');
                console.log(selectedCard);
...
var menuButton = document.querySelector("#dropdown-menu-button");
var menu = document.querySelector("#dropdown-menu");
menuButton.addEventListener("click", function () {
    menu.classList.toggle("hidden");
});
docListItems.forEach(function (item) {
